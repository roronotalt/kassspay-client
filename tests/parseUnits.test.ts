...
import { parseUnits } from '../index.js';
...
test('converts number to unit of a given length', () => {
	...
	expect(parseUnits('6942123123123069420.1234544444678912345', 50)).toMatchInlineSnapshot(
...
test('decimals === 0', () => {
	expect(parseUnits('69.2352112312312451512412341231', 0)).toMatchInlineSnapshot('69n');
	expect(parseUnits('69.5952141234124125231523412312', 0)).toMatchInlineSnapshot('70n');
...
test('decimals < fraction length', () => {
	...
	expect(parseUnits('9.9999999999999999', 7)).toMatchInlineSnapshot('100000000n');
